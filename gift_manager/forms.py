...
class EventForm(forms.ModelForm):
    date_type = forms.ChoiceField(label=gettext_lazy('Date Type'), choices=[('absolute', gettext_lazy('Absolute Date')), ('recurrence', gettext_lazy('Recurrent'))], widget=forms.RadioSelect)
