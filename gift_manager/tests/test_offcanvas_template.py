...
class TestOffcanvasTemplate:
    ...
    def test_offcanvas_base_template_renders(self):
        ...
        assert_text_in_rendered('id="editPanel"', rendered)
        assert_text_in_rendered('id="detailPanel"', rendered)
        assert_text_in_rendered("offcanvas-end", rendered)
        assert_text_in_rendered("offcanvas-panel", rendered)
    ...
    def test_offcanvas_has_required_elements(self):
        ...
        assert_text_in_rendered('id="editPanelLabel"', rendered)
        assert_text_in_rendered('id="offcanvasContent"', rendered)
        assert_text_in_rendered('id="offcanvasLoading"', rendered)
        assert_text_in_rendered('id="offcanvasError"', rendered)

        # Check for detail panel elements
        assert_text_in_rendered('id="detailPanelLabel"', rendered)
        assert_text_in_rendered('id="detailContent"', rendered)
        assert_text_in_rendered('id="detailLoading"', rendered)
        assert_text_in_rendered('id="detailError"', rendered)
    ...
    def test_offcanvas_has_accessibility_features(self):
        ...
        assert_text_in_rendered('tabindex="-1"', rendered)
        assert_text_in_rendered("aria-labelledby=", rendered)
        assert_text_in_rendered("aria-label=", rendered)
        assert_text_in_rendered('data-bs-keyboard="true"', rendered)
    ...
    def test_offcanvas_has_loading_and_error_states(self):
        ...
        assert_text_in_rendered("loading-state", rendered)
        assert_text_in_rendered("loading-spinner", rendered)

        # Check for error states
        assert_text_in_rendered("error-state", rendered)
        assert_text_in_rendered("alert-danger", rendered)

        # Check for retry functionality
        assert_text_in_rendered("retryOffcanvasLoad", rendered)
        assert_text_in_rendered("retryDetailLoad", rendered)
    ...
    def test_offcanvas_javascript_functions_defined(self):
        ...
        assert_text_in_rendered("showOffcanvasLoading", rendered)
        assert_text_in_rendered("hideOffcanvasLoading", rendered)
        assert_text_in_rendered("showOffcanvasError", rendered)
        assert_text_in_rendered("retryOffcanvasLoad", rendered)
        assert_text_in_rendered("retryDetailLoad", rendered)
    ...
    def test_form_partial_template_renders(self):
        ...
        assert_text_in_rendered("offcanvas-form", rendered)
        assert_text_in_rendered("panel-form-actions", rendered)
        assert_text_in_rendered('hx-post="/test/"', rendered)
    ...
    def test_form_partial_has_htmx_integration(self):
        ...
        assert_text_in_rendered("hx-post=", rendered)
