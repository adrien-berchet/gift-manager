...
ENTITY_TYPE_MAPPINGS = {
    ...
    "event": {
        ...
        "pk_field": "event_id",
        "required_fields": ["name"],
        "optional_fields": ["comment", "usual_date", "recurrence"],
        "url_patterns": {
...
PROPERTY_METADATA = {
    1: {
        ...
        "description": "For any entity type and any UI action, clicking the corresponding button should display the appropriate UI component with the correct content and structure.",
        "requirements": ["1.1", "2.1", "3.1", "5.1"],
        "test_method": "test_property_1_ui_component_display_consistency",
    },
    2: {
        "name": "Data Population Accuracy",
        "description": "For any entity and any form or detail view, when the UI component is displayed, all fields and information should be populated with the current entity data accurately and completely.",
        "requirements": ["2.2", "3.2", "5.2"],
        "test_method": "test_property_2_data_population_accuracy",
    },
    3: {
        "name": "Successful Operation Completion",
        "description": "For any valid CRUD operation, when the operation completes successfully, the entity should be modified as expected and the current view should be updated without page reload.",
        "requirements": ["1.3", "2.4", "4.4", "5.3"],
        "test_method": "test_property_3_successful_operation_completion",
    },
    4: {
        "name": "Error Handling Consistency",
        "description": "For any operation that fails due to validation errors, constraints, or permissions, appropriate error messages should be displayed within the current UI component without closing it.",
        "requirements": ["1.5", "2.6", "5.4"],
        "test_method": "test_property_4_error_handling_consistency",
    },
    5: {
        "name": "Cancellation Behavior",
        "description": "For any UI component, when a user cancels or closes the component, it should close properly and maintain the current application state without any changes.",
        "requirements": ["1.4", "2.5", "3.5"],
        "test_method": "test_property_5_cancellation_behavior",
    },
    6: {
        "name": "Permission-Based UI Adaptation",
        "description": "For any user with specific permissions, the UI should only display action buttons and operations that the user is authorized to perform.",
        "requirements": ["4.5", "5.5", "6.5"],
        "test_method": "test_property_6_permission_based_ui_adaptation",
    },
    7: {
        "name": "Quick Actions Availability",
        "description": "For any entity list, each item should display appropriate quick action buttons that are accessible and functional.",
        "requirements": ["4.1", "4.2"],
        "test_method": "test_property_7_quick_actions_availability",
    },
    8: {
        "name": "Inline Editing Functionality",
        "description": "For any editable field in list views, double-clicking should activate inline editing, and completing the edit should save the change via AJAX with visual feedback.",
        "requirements": ["4.3", "4.4"],
        "test_method": "test_property_8_inline_editing_functionality",
    },
    9: {
        "name": "Bulk Operations Support",
        "description": "For any entity list with multiple items selected, the system should provide bulk operation capabilities with appropriate confirmation dialogs and progress feedback.",
        "requirements": ["6.1", "6.2", "6.3", "6.4"],
        "test_method": "test_property_9_bulk_operations_support",
    },
    10: {
        "name": "Real-Time List Features",
        "description": "For any list view, search and filter operations should update results immediately without page reload, and expandable rows should reveal details without navigation.",
        "requirements": ["7.1", "7.2", "7.3"],
        "test_method": "test_property_10_real_time_list_features",
    },
    11: {
        "name": "Loading State Feedback",
        "description": "For any operation that takes time to complete, appropriate loading indicators should be displayed, and form controls should be disabled during submission.",
        "requirements": ["8.1", "8.2", "8.3", "8.4"],
        "test_method": "test_property_11_loading_state_feedback",
    },
    12: {
        "name": "Mobile Responsiveness",
        "description": "For any screen size, UI components should adapt appropriately with full-screen panels on small screens, touch-friendly elements, and proper keyboard handling.",
        "requirements": ["9.1", "9.2", "9.3", "9.5"],
        "test_method": "test_property_12_mobile_responsiveness",
    },
    13: {
        "name": "Keyboard Accessibility",
        "description": "For any modal or panel, keyboard navigation should work properly with visible focus indicators, Escape key should close components, and common shortcuts should be supported.",
        "requirements": ["10.1", "10.2", "10.3", "10.5"],
        "test_method": "test_property_13_keyboard_accessibility",
    },
    14: {
        "name": "Unsaved Changes Protection",
        "description": "For any form with unsaved changes, attempting to navigate away or close should prompt the user to save or discard changes, with visual indicators showing modified state.",
