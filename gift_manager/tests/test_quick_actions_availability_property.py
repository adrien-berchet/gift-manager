...
class TestQuickActionsAvailabilityProperty:
    ...
    def test_quick_actions_permission_based_availability(self, entity_type, entity_data, permission_level):
        """
        Feature: modern-ux-interface, Property 7: Quick Actions Availability
        ...
        # Verify response is successful
        assert response.status_code == 200, f"List view failed for {entity_type} with restricted permissions"
